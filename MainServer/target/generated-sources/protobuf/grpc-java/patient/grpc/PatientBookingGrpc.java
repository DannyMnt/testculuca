...
public final class PatientBookingGrpc {
  ...
  public static final io.grpc.MethodDescriptor<patient.grpc.bookingRequest,
      patient.grpc.DBresponse> METHOD_BOOK_APPOINTMENT =
      io.grpc.MethodDescriptor.<patient.grpc.bookingRequest, patient.grpc.DBresponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "PatientBooking", "bookAppointment"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              patient.grpc.bookingRequest.getDefaultInstance()))
  ...
  public static abstract class PatientBookingImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void bookAppointment(patient.grpc.bookingRequest request,
        io.grpc.stub.StreamObserver<patient.grpc.DBresponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_BOOK_APPOINTMENT, responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            METHOD_BOOK_APPOINTMENT,
            asyncUnaryCall(
              new MethodHandlers<
                patient.grpc.bookingRequest,
  ...
  public static final class PatientBookingStub extends io.grpc.stub.AbstractStub<PatientBookingStub> {
    ...
    public void bookAppointment(patient.grpc.bookingRequest request,
        io.grpc.stub.StreamObserver<patient.grpc.DBresponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_BOOK_APPOINTMENT, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class PatientBookingBlockingStub extends io.grpc.stub.AbstractStub<PatientBookingBlockingStub> {
    ...
    /**
     */
    public patient.grpc.DBresponse bookAppointment(patient.grpc.bookingRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_BOOK_APPOINTMENT, getCallOptions(), request);
    }
  }
  ...
  public static final class PatientBookingFutureStub extends io.grpc.stub.AbstractStub<PatientBookingFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<patient.grpc.DBresponse> bookAppointment(
        patient.grpc.bookingRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_BOOK_APPOINTMENT, getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_BOOK_APPOINTMENT:
          serviceImpl.bookAppointment((patient.grpc.bookingRequest) request,
              (io.grpc.stub.StreamObserver<patient.grpc.DBresponse>) responseObserver);
          break;
        default:
      ...
      synchronized (PatientBookingGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_BOOK_APPOINTMENT)
              .build();
        }
      }
    }
